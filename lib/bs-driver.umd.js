(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory() } else if (typeof define === 'function' && define.amd) { define([], factory) } else if (typeof exports === 'object') { exports.BsDriver = factory() } else { root.BsDriver = factory() }
...
*/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var update = add('27837fbf', content, true, { sourceMap: false, shadowMode: false })
      /***/ },
...
*/
      ...
      function popperOffsets (_ref) {
        var state = _ref.state
        var name = _ref.name // Offsets are the actual position the popper needs to have to be
 ...
 */
      ...
      function _mergeModifiers (stepOptions, popperOptions) {
        if (stepOptions.popperOptions) {
          const mergedPopperOptions = Object.assign({}, popperOptions, stepOptions.popperOptions)
   ...
   */
      ...
      var components_install = function install (Vue) {
        ...
        Vue.prototype.$shepherd = function () {
          ...
          // 设置初始化参数
          var props = _objectSpread2(_objectSpread2({}, defaultConfig), args)

          return new shepherd_esm.Tour(props)
        } // 将默认配置挂上去
...
// # sourceMappingURL=bs-driver.umd.js.map
